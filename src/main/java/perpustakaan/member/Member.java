...
public class Member extends Database {
    ...
    /**
     * Tandai email member sebagai "sudah terverifikasi".
     */
//    public void markEmailAsVerified() {
//        // Menetapkan tanggal verifikasi email member dengan waktu saat kode ini dijalankan
//        this.tanggalEmailTerverifikasi = new Date();
//    }
    
    /**
     * Mengambil data member berdasarkan "id".
     * Kemudian data tersebut disimpan ke masing-masing property (nama, email, tanggalEmailTerverifikasi, nomorTelepon).
     * @param id
     * @return Boolean
     */
    ...
    /**
     * Menghapus data member di database
     * @return 
     */
