...
public class Database {     
    ...
    private final static String dbname = "pbo_perpustakaan"; // nama databasenya
     ...
     * Setelah dibuka, jangan lupa tutup lagi koneksinya menggunakan method closeConnection
     */
     ...
     * Jalankan method ini ketika sudah selesai berurusan dengan database.
     */
    ...
    /**
     * Ambil lebih dari satu data dengan statement query SELECT
     * @param query
     * @return ArrayList
     */
